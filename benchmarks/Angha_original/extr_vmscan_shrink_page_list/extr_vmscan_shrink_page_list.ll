; ModuleID = 'extr_vmscan_shrink_page_list.c'
source_filename = "extr_vmscan_shrink_page_list.c"
...
define internal i64 @shrink_page_list(%struct.list_head* %0, %struct.scan_control* %1, %struct.mem_cgroup_zone* %2, i32 %3, i32 %4, i64* %5, i64* %6) #0 {
  ...
  %15 = alloca %struct.pagevec, align 4
  ...
  %28 = call i32 @pagevec_init(%struct.pagevec* %15, i32 1)
  br label %29
...
34:                                               ; preds = %29
  ...
  %37 = call %struct.page* @lru_to_page(%struct.list_head* %36)
  store %struct.page* %37, %struct.page** %23, align 8
  %38 = load %struct.page*, %struct.page** %23, align 8
  %39 = getelementptr inbounds %struct.page, %struct.page* %38, i32 0, i32 0
  %40 = call i32 @list_del(i32* %39)
  %41 = load %struct.page*, %struct.page** %23, align 8
  %42 = call i32 @trylock_page(%struct.page* %41)
  %43 = icmp ne i32 %42, 0
...
45:                                               ; preds = %34
  %46 = load %struct.page*, %struct.page** %23, align 8
  %47 = call i32 @PageActive(%struct.page* %46)
  %48 = call i32 @VM_BUG_ON(i32 %47)
  %49 = load %struct.page*, %struct.page** %23, align 8
  %50 = call i64 @page_zone(%struct.page* %49)
  ...
  %61 = load %struct.page*, %struct.page** %23, align 8
  %62 = call i32 @page_evictable(%struct.page* %61, i32* null)
  %63 = icmp ne i32 %62, 0
  %64 = xor i1 %63, true
...
79:                                               ; preds = %74, %69
  %80 = load %struct.page*, %struct.page** %23, align 8
  %81 = call i64 @page_mapped(%struct.page* %80)
  %82 = icmp ne i64 %81, 0
  br i1 %82, label %87, label %83

83:                                               ; preds = %79
  %84 = load %struct.page*, %struct.page** %23, align 8
  %85 = call i64 @PageSwapCache(%struct.page* %84)
  %86 = icmp ne i64 %85, 0
...
99:                                               ; preds = %92
  ...
  %101 = call i64 @PageSwapCache(%struct.page* %100)
...
112:                                              ; preds = %110, %92
  ...
  %115 = load %struct.page*, %struct.page** %23, align 8
  %116 = call i64 @PageWriteback(%struct.page* %115)
...
127:                                              ; preds = %124
  %128 = load %struct.page*, %struct.page** %23, align 8
  %129 = call i32 @wait_on_page_writeback(%struct.page* %128)
  br label %131
...
132:                                              ; preds = %131, %112
  %133 = load %struct.page*, %struct.page** %23, align 8
  ...
  %136 = call i32 @page_check_references(%struct.page* %133, %struct.mem_cgroup_zone* %134, %struct.scan_control* %135)
...
141:                                              ; preds = %140, %132
  %142 = load %struct.page*, %struct.page** %23, align 8
  %143 = call i64 @PageAnon(%struct.page* %142)
  %144 = icmp ne i64 %143, 0
  br i1 %144, label %145, label %163

145:                                              ; preds = %141
  %146 = load %struct.page*, %struct.page** %23, align 8
  %147 = call i64 @PageSwapCache(%struct.page* %146)
...
157:                                              ; preds = %149
  %158 = load %struct.page*, %struct.page** %23, align 8
  %159 = call i32 @add_to_swap(%struct.page* %158)
...
163:                                              ; preds = %162, %145, %141
  %164 = load %struct.page*, %struct.page** %23, align 8
  %165 = call %struct.address_space* @page_mapping(%struct.page* %164)
  store %struct.address_space* %165, %struct.address_space** %22, align 8
  %166 = load %struct.page*, %struct.page** %23, align 8
  %167 = call i64 @page_mapped(%struct.page* %166)
  %168 = icmp ne i64 %167, 0
  br i1 %168, label %169, label %181

169:                                              ; preds = %163
  %170 = load %struct.address_space*, %struct.address_space** %22, align 8
  %171 = icmp ne %struct.address_space* %170, null
  br i1 %171, label %172, label %181

172:                                              ; preds = %169
  %173 = load %struct.page*, %struct.page** %23, align 8
  %174 = load i32, i32* @TTU_UNMAP, align 4
  %175 = call i32 @try_to_unmap(%struct.page* %173, i32 %174)
...
181:                                              ; preds = %180, %169, %163
  %182 = load %struct.page*, %struct.page** %23, align 8
  %183 = call i64 @PageDirty(%struct.page* %182)
...
185:                                              ; preds = %181
  ...
  %188 = load %struct.page*, %struct.page** %23, align 8
  %189 = call i64 @page_is_file_cache(%struct.page* %188)
...
199:                                              ; preds = %194, %191
  %200 = load %struct.page*, %struct.page** %23, align 8
  %201 = call i32 @SetPageReclaim(%struct.page* %200)
  br label %335
...
216:                                              ; preds = %210
  %217 = load %struct.page*, %struct.page** %23, align 8
  %218 = load %struct.address_space*, %struct.address_space** %22, align 8
  %219 = load i32, i32* %11, align 4
  %220 = call i32 @pageout(%struct.page* %217, %struct.address_space* %218, i32 %219)
...
225:                                              ; preds = %216
  %226 = load %struct.page*, %struct.page** %23, align 8
  %227 = call i64 @PageWriteback(%struct.page* %226)
  %228 = icmp ne i64 %227, 0
  br i1 %228, label %233, label %229

229:                                              ; preds = %225
  %230 = load %struct.page*, %struct.page** %23, align 8
  %231 = call i64 @PageDirty(%struct.page* %230)
...
234:                                              ; preds = %229
  %235 = load %struct.page*, %struct.page** %23, align 8
  %236 = call i32 @trylock_page(%struct.page* %235)
...
239:                                              ; preds = %234
  %240 = load %struct.page*, %struct.page** %23, align 8
  %241 = call i64 @PageDirty(%struct.page* %240)
  %242 = icmp ne i64 %241, 0
  br i1 %242, label %247, label %243

243:                                              ; preds = %239
  %244 = load %struct.page*, %struct.page** %23, align 8
  %245 = call i64 @PageWriteback(%struct.page* %244)
...
248:                                              ; preds = %243
  %249 = load %struct.page*, %struct.page** %23, align 8
  %250 = call %struct.address_space* @page_mapping(%struct.page* %249)
  store %struct.address_space* %250, %struct.address_space** %22, align 8
  br label %251
...
253:                                              ; preds = %252, %181
  %254 = load %struct.page*, %struct.page** %23, align 8
  %255 = call i64 @page_has_private(%struct.page* %254)
  %256 = icmp ne i64 %255, 0
  br i1 %256, label %257, label %283

257:                                              ; preds = %253
  %258 = load %struct.page*, %struct.page** %23, align 8
  ...
  %262 = call i32 @try_to_release_page(%struct.page* %258, i32 %261)
...
265:                                              ; preds = %257
  %266 = load %struct.address_space*, %struct.address_space** %22, align 8
  %267 = icmp ne %struct.address_space* %266, null
  br i1 %267, label %282, label %268

268:                                              ; preds = %265
  %269 = load %struct.page*, %struct.page** %23, align 8
  %270 = call i32 @page_count(%struct.page* %269)
  %271 = icmp eq i32 %270, 1
  br i1 %271, label %272, label %282

272:                                              ; preds = %268
  %273 = load %struct.page*, %struct.page** %23, align 8
  %274 = call i32 @unlock_page(%struct.page* %273)
  %275 = load %struct.page*, %struct.page** %23, align 8
  %276 = call i64 @put_page_testzero(%struct.page* %275)
...
283:                                              ; preds = %282, %253
  %284 = load %struct.address_space*, %struct.address_space** %22, align 8
  %285 = icmp ne %struct.address_space* %284, null
  br i1 %285, label %286, label %291

286:                                              ; preds = %283
  %287 = load %struct.address_space*, %struct.address_space** %22, align 8
  %288 = load %struct.page*, %struct.page** %23, align 8
  %289 = call i32 @__remove_mapping(%struct.address_space* %287, %struct.page* %288)
...
292:                                              ; preds = %286
  %293 = load %struct.page*, %struct.page** %23, align 8
  %294 = call i32 @__clear_page_locked(%struct.page* %293)
  br label %295
...
295:                                              ; preds = %292, %278
  ...
  %298 = load %struct.page*, %struct.page** %23, align 8
  %299 = call i32 @pagevec_add(%struct.pagevec* %15, %struct.page* %298)
  %300 = icmp ne i32 %299, 0
  br i1 %300, label %304, label %301

301:                                              ; preds = %295
  %302 = call i32 @__pagevec_free(%struct.pagevec* %15)
  %303 = call i32 @pagevec_reinit(%struct.pagevec* %15)
  br label %304
...
305:                                              ; preds = %178, %68
  %306 = load %struct.page*, %struct.page** %23, align 8
  %307 = call i64 @PageSwapCache(%struct.page* %306)
  %308 = icmp ne i64 %307, 0
  br i1 %308, label %309, label %312

309:                                              ; preds = %305
  %310 = load %struct.page*, %struct.page** %23, align 8
  %311 = call i32 @try_to_free_swap(%struct.page* %310)
  br label %312

312:                                              ; preds = %309, %305
  %313 = load %struct.page*, %struct.page** %23, align 8
  %314 = call i32 @unlock_page(%struct.page* %313)
  %315 = load %struct.page*, %struct.page** %23, align 8
  %316 = call i32 @putback_lru_page(%struct.page* %315)
  br label %29

317:                                              ; preds = %264, %224, %176, %161, %138
  %318 = load %struct.page*, %struct.page** %23, align 8
  %319 = call i64 @PageSwapCache(%struct.page* %318)
...
324:                                              ; preds = %321
  %325 = load %struct.page*, %struct.page** %23, align 8
  %326 = call i32 @try_to_free_swap(%struct.page* %325)
  br label %327

327:                                              ; preds = %324, %321, %317
  %328 = load %struct.page*, %struct.page** %23, align 8
  %329 = call i32 @PageActive(%struct.page* %328)
  %330 = call i32 @VM_BUG_ON(i32 %329)
  %331 = load %struct.page*, %struct.page** %23, align 8
  %332 = call i32 @SetPageActive(%struct.page* %331)
...
335:                                              ; preds = %327, %291, %247, %221, %215, %209, %205, %199, %177, %156, %139, %130, %78
  %336 = load %struct.page*, %struct.page** %23, align 8
  %337 = call i32 @unlock_page(%struct.page* %336)
  br label %338

338:                                              ; preds = %335, %238, %233, %44
  %339 = load %struct.page*, %struct.page** %23, align 8
  %340 = getelementptr inbounds %struct.page, %struct.page* %339, i32 0, i32 0
  %341 = call i32 @list_add(i32* %340, i32* @ret_pages)
  %342 = load %struct.page*, %struct.page** %23, align 8
  %343 = call i64 @PageLRU(%struct.page* %342)
  %344 = icmp ne i64 %343, 0
  br i1 %344, label %349, label %345

345:                                              ; preds = %338
  %346 = load %struct.page*, %struct.page** %23, align 8
  %347 = call i64 @PageUnevictable(%struct.page* %346)
...
370:                                              ; preds = %364, %360, %356, %353
  ...
  %373 = call i64 @pagevec_count(%struct.pagevec* %15)
  %374 = icmp ne i64 %373, 0
  br i1 %374, label %375, label %377

375:                                              ; preds = %370
  %376 = call i32 @__pagevec_free(%struct.pagevec* %15)
  br label %377
...
declare dso_local i32 @page_check_references(%struct.page*, %struct.mem_cgroup_zone*, %struct.scan_control*) #1

declare dso_local i64 @PageAnon(%struct.page*) #1

declare dso_local i32 @add_to_swap(%struct.page*) #1
...
declare dso_local i32 @pageout(%struct.page*, %struct.address_space*, i32) #1
...
declare dso_local i32 @__remove_mapping(%struct.address_space*, %struct.page*) #1

declare dso_local i32 @__clear_page_locked(%struct.page*) #1

declare dso_local i32 @pagevec_add(%struct.pagevec*, %struct.page*) #1

declare dso_local i32 @__pagevec_free(%struct.pagevec*) #1
