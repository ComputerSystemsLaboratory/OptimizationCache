...
%struct.ieee80211_sta = type { %struct.il_rate_scale_data }
...
@llvm.used = appending global [1 x i8*] [i8* bitcast (i32 (%struct.il_priv*, %struct.il_lq_sta*, %struct.il_rate_scale_data*, %struct.ieee80211_sta*, i32)* @il4965_rs_move_siso_to_other to i8*)], section "llvm.metadata"
...
define internal i32 @il4965_rs_move_siso_to_other(%struct.il_priv* %0, %struct.il_lq_sta* %1, %struct.il_rate_scale_data* %2, %struct.ieee80211_sta* %3, i32 %4) #0 {
  %6 = alloca i32, align 4
  %7 = alloca %struct.il_priv*, align 8
  %8 = alloca %struct.il_lq_sta*, align 8
  %9 = alloca %struct.il_rate_scale_data*, align 8
  ...
  %16 = alloca %struct.il_rate_scale_data*, align 8
  ...
  store %struct.il_rate_scale_data* %2, %struct.il_rate_scale_data** %9, align 8
  ...
  store %struct.il_rate_scale_data* %49, %struct.il_rate_scale_data** %16, align 8
...
150:                                              ; preds = %142
  ...
  %153 = load %struct.il_rate_scale_data*, %struct.il_rate_scale_data** %9, align 8
  ...
  %157 = call i32 @il4965_rs_switch_to_mimo2(%struct.il_priv* %151, %struct.il_lq_sta* %152, %struct.il_rate_scale_data* %153, %struct.ieee80211_sta* %154, %struct.il_scale_tbl_info* %155, i32 %156)
...
167:                                              ; preds = %162
  %168 = load %struct.il_rate_scale_data*, %struct.il_rate_scale_data** %16, align 8
  %169 = getelementptr inbounds %struct.il_rate_scale_data, %struct.il_rate_scale_data* %168, i32 0, i32 0
...
180:                                              ; preds = %175
  %181 = load %struct.il_rate_scale_data*, %struct.il_rate_scale_data** %16, align 8
  %182 = getelementptr inbounds %struct.il_rate_scale_data, %struct.il_rate_scale_data* %181, i32 0, i32 0
...
245:                                              ; preds = %235, %201, %187, %174, %161, %149, %111, %98, %91, %66
...
declare dso_local i32 @il4965_rs_switch_to_mimo2(%struct.il_priv*, %struct.il_lq_sta*, %struct.il_rate_scale_data*, %struct.ieee80211_sta*, %struct.il_scale_tbl_info*, i32) #1
