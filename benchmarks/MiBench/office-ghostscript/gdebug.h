...
#  define if_debug0(c,s)\
    if (gs_debug_c(c)) dprintf_(s)
#  define if_debug1(c,s,a1)\
    if (gs_debug_c(c)) dprintf_1(s,a1)
#  define if_debug2(c,s,a1,a2)\
    if (gs_debug_c(c)) dprintf_2(s,a1,a2)
#  define if_debug3(c,s,a1,a2,a3)\
    if (gs_debug_c(c)) dprintf_3(s,a1,a2,a3)
#  define if_debug4(c,s,a1,a2,a3,a4)\
    if (gs_debug_c(c)) dprintf_4(s,a1,a2,a3,a4)
#  define if_debug5(c,s,a1,a2,a3,a4,a5)\
    if (gs_debug_c(c)) dprintf_5(s,a1,a2,a3,a4,a5)
#  define if_debug6(c,s,a1,a2,a3,a4,a5,a6)\
    if (gs_debug_c(c)) dprintf_6(s,a1,a2,a3,a4,a5,a6)
#  define if_debug7(c,s,a1,a2,a3,a4,a5,a6,a7)\
    if (gs_debug_c(c)) dprintf_7(s,a1,a2,a3,a4,a5,a6,a7)
#  define if_debug8(c,s,a1,a2,a3,a4,a5,a6,a7,a8)\
    if (gs_debug_c(c)) dprintf_8(s,a1,a2,a3,a4,a5,a6,a7,a8)
#  define if_debug9(c,s,a1,a2,a3,a4,a5,a6,a7,a8,a9)\
    if (gs_debug_c(c)) dprintf_9(s,a1,a2,a3,a4,a5,a6,a7,a8,a9)
#  define if_debug10(c,s,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)\
    if (gs_debug_c(c)) dprintf_10(s,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
#  define if_debug11(c,s,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11)\
    if (gs_debug_c(c)) dprintf_11(s,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11)
#  define if_debug12(c,s,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12)\
    if (gs_debug_c(c)) dprintf_12(s,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12)
#else
