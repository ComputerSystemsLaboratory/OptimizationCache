...
class BestK:
    ...
    def run(self,
        ...
        for training_benchmark in training_benchmarks:
            ...
            baseline_goal_value = IO.load_yaml_or_fail(
                '{}/{}.yaml'.format(baseline_dir,
                                    bench_name)
            )
            baseline_goal_value = baseline_goal_value[compiler][baseline]['goal']
            ...
            for seq in training_sequences.keys():
                ...
                if goal_value < baseline_goal_value:
                    improvement = ((baseline_goal_value - goal_value) / baseline_goal_value) * 100
